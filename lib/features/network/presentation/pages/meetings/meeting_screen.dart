...
class _MeetingScreenState extends State<MeetingScreen>
  ...
  final RxInt _markerRefresh = 0.obs;
        ...
        children: [
          ...
          Obx(() {
            ...
            return _CalendarCard(
              key: ValueKey(
                'cal_${marks.length}_${_calendarFormat.value.index}',
              ),
              selectedDate: _selectedDate.value,
              focusedDate: _focusedDate.value,
              format: _calendarFormat.value,
              markedDates: marks,
              onDaySelected: _onDaySelected,
              onPageChanged: (focused) => _focusedDate.value = focused,
              onFormatChanged: (fmt) => _calendarFormat.value = fmt,
            );
          }),
