...
import 'package:loci/features/checkin/presentation/widgets/scanner_animation.dart';
...
class _CheckInScreenState extends State<CheckInScreen> {
      ...
      if (success) {
        ...
        if (_type == "event" && Get.isRegistered<EventDetailsController>()) {
          Get.find<EventDetailsController>().updateCheckInStatus(
            ...
            Get.isRegistered<RouteDetailsController>()) {
  ...
  Widget _buildScannerTab() {
    ...
    return Obx(() {
      final isProcessing = _isProcessing.value;
      return Column(
                ...
                children: [
                  MobileScanner(
                    ...
                    onDetect: (capture) {
                      ...
                      if (code.isNotEmpty && !isProcessing) {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(() {
                final controller = manualCheckInController;
                return CustomButton(
                  text: "Check-In Manually",
                  isLoading: controller.isLoading,
                  onPressed: controller.isLoading ? null : _onManualCheckIn,
                );
              }),
            ],
          ),
