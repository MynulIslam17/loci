...
class _EditRoutesScreenState extends State<EditRoutesScreen> {
  ...
  final selectAvailabilityType = Rxn<RouteType>();
  ...
  void _onStateChange() => formTick.value++;
  ...
  void _populateFields() {
    final route = _routeController.routeDetails.value?.routeModel;
    final details = _routeController.routeDetails.value;
    ...
    selectAvailabilityType.value = _initialData!['availabilityType'];
  ...
  void _handleUpdate() async {
    ...
    final request = RouteUpdateRequest(
      routeId: routeId,
      title: titleTEController.text != route.title
          ? titleTEController.text
          : null,
      details: detailsTEController.text != route.details
          ? detailsTEController.text
          : null,
      location: locationTEController.text != route.location
          ? locationTEController.text
          : null,
      url: mapUrlTEController.text != (details.mapUrl ?? "")
          ? mapUrlTEController.text
          : null,
      isPublic: isPublic.value != route.isRoutePublic ? isPublic.value : null,
      availabilityType:
          selectAvailabilityType.value?.apiValue != route.activityType
          ? selectAvailabilityType.value
          : null,
      openingTime: timeTEController.text != _initialData!['time']
    ...
    if (success) {
      ...
      SnackbarService.success(_routeUpdateController.errorMessage.value!);
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        final controller = Get.find<BusinessRouteDetailsController>();
        ...
        if (controller.errorMessage.value != null) {
          return ErrorStateWidget(
            ...
            onRetry: () => _routeController.fetchRouteDetails(routeId),
          );
        }

        final routeDetails = controller.routeDetails.value;
          ...
          children: [
            ...
            Expanded(
              child: CustomDropdown(
                ...
                value: selectAvailabilityType.value,
                ...
                items: RouteType.values
                    ...
                    .toList(),
                onChanged: (v) {
                  selectAvailabilityType.value = v;
                  formTick.value++;
                },
              ),
            ),
    ...
    return Obx(
      () => Row(
        children: [
          ...
          const Spacer(),
          Text(isPublic.value ? "Public" : "Private"),
          Switch(
  ...
  Widget _buildBottomButtons(ColorScheme colorScheme) {
    return Row(
      children: [
        ...
        Expanded(
          child: Obx(() {
            final updateController = Get.find<BusinessRouteUpdateController>();
            formTick.value;
            return CustomButton(
              isLoading: updateController.isLoading.value,
              text: "Update",
              onPressed: !_isChanged ? null : _handleUpdate,
            );
          }),
        ),
      ],
