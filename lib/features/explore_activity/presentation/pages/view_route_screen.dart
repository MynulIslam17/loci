...
class _ViewRouteScreenState extends State<ViewRouteScreen> {
  ...
  final routeDetailsController = Get.find<BusinessRouteDetailsController>();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        final controller = routeDetailsController;
        ...
        if (controller.errorMessage.value != null) {
          return ErrorStateWidget(
            ...
            onRetry: () => routeDetailsController.fetchRouteDetails(routeId),
          );
        }

        /// ===== EMPTY =====
        if (controller.routeDetails.value == null) {
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              /// 4. Check-in Counter
              _buildCheckInCounter(colorScheme, routeDetails.checkInCount),
              ...
              CustomButton(
                ...
                onPressed: () =>
                    _qrCodeDownloadHandler(context, routeDetails.qrCode),
                child: Row(
  ...
  /// ===== CHECKIN COUNTER =====
  Widget _buildCheckInCounter(ColorScheme colorScheme, int count) {
    return Center(
      child: Card(
        elevation: 2,
