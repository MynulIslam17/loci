...
class _ScheduleMeetingScreenState extends State<ScheduleMeetingScreen> {
  ...
  Future<void> _onSubmit() async {
    ...
    final meetingDate = DateParserHelper.toApiDate(_selectedDate);
    ...
    if (success) {
      ...
      SnackbarService.error(_controller.errorMessage ?? "Failed to schedule meeting");
    }
  }
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                GetBuilder<ScheduleMeetingController>(
