...
class _SendNewReferralsScreenState extends State<SendNewReferralsScreen> {
  ...
  void initState() {
    super.initState();
    _controller = Get.put(SendNewReferralsController());
  }
  ...
  Future<void> _onSubmit() async {
    ...
    if (success) {
      ...
      SnackbarService.error(_controller.errorMessage ?? "Failed to send referral");
    }
  }
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildField(
                        ...
                        validator: (v) => validateRequired(v, fieldName: "Company"),
                      ),
                ...
                GetBuilder<SendNewReferralsController>(
