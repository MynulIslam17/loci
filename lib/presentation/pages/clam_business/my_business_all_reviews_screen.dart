...
import 'package:loci/presentation/pages/clam_business/widgets/all_reviews_shimmer.dart';
...
class _MyBusinessAllReviewsScreenState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<MyBusinessReviewController>(
        builder: (ctrl) {
          // ── Loading ────────────────────────────────────────────────────
          if (ctrl.isLoading) return const AllReviewsShimmer();
