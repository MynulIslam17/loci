...
import 'package:loci/presentation/widgets/paginated_search_list.dart';
...
class BusinessSearchResultWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<FindGoogleBusinessController>(
      builder: (controller) {
        if (!controller.showResults) return const SizedBox.shrink();
        ...
        return PaginatedSearchDropdown<Business>(
          ...
          maxHeight: 220,
          emptyWidget: controller.isLoading
              ? null
              : Padding(
          ...
          itemBuilder: (context, business, index) {
            final isSelected =
                controller.selectedBusiness?.placeId == business.placeId;
